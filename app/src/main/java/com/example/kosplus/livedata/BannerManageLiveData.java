...
public class BannerManageLiveData extends ViewModel {
    ...
    private void loadData() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                List<Banners> enabled = new ArrayList<>();
                List<Banners> disabled = new ArrayList<>();
                for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                    ...
                    if (banners.status) {
                        ...
                        disabled.add(banners);
                    }
                }

                enabled.sort(Comparator.comparingInt(Banners::getPosition));
